        ...
        {activeTab === 'expenses' && (
          <Panel title="Expenses and bills">
            <div className="grid gap-3 md:grid-cols-7">
              ...
              <Select label="Priority" value={expenseDraft.priority} onChange={(value) => setExpenseDraft({ ...expenseDraft, priority: value as ExpensePriority })} options={['must-pay', 'important', 'flexible', 'pauseable', 'cah']} />
            ...
            <div className="flex max-h-[calc(100dvh-2rem)] w-full max-w-2xl flex-col overflow-hidden rounded-[2rem] border border-emerald-300/30 bg-[#081711] shadow-2xl shadow-black/60 sm:max-h-[calc(100dvh-3rem)]">
              ...
              <div className="min-h-0 flex-1 space-y-5 overflow-y-auto p-5 sm:p-6">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <Select label="Priority" value={expenseEditDraft.priority} onChange={(value) => setExpenseEditDraft({ ...expenseEditDraft, priority: value as ExpensePriority })} options={['must-pay', 'important', 'flexible', 'pauseable', 'cah']} />
